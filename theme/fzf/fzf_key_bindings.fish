...
function fzf_key_bindings -d 'Adds aquarium compatible fzf key bindings'
  # When run this script will add the following functions and keybindings to your fish shell:
  # - (Ctrl + R) fzf-history-widget: Show fish command history
  # - (Ctrl + T) fzf-cd-widget: Change directories using your keys and mouse
